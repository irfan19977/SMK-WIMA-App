...
console.log('Window Late Statistics:', window.lateStatistics);
console.log('Window Donut Statistics:', window.donutStatistics);
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              show: true,
              fontSize: "16px",
              label: window.translations ? window.translations.total_attendance : "Total Kehadiran",
              color: "#9599ad",
              fontWeight: 400,
...
var radialChart = new ApexCharts(document.querySelector("#social-source"), options);
radialChart.render();

// Function to update charts when language changes
window.updateChartsLanguage = function() {
    ...
    donutChart.updateOptions({
        labels: window.donutStatistics ? window.donutStatistics.labels : [
            window.translations.on_time || 'Tepat Waktu', 
            window.translations.late || 'Terlambat', 
            window.translations.others || 'Lainnya'
        ],
        plotOptions: {
            pie: {
                donut: {
                    labels: {
                        total: {
                            label: window.translations.total_attendance || "Total Kehadiran"
                        }
                    }
                }
            }
