        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                <button type="button" class="btn header-item waves-effect"
                    ...
                    <img src="{{ (auth()->check() ? (auth()->user()->language ?? 'id') : (session('locale') ?? 'id')) === 'id' ? URL::asset('build/images/flags/indonesia.png') : URL::asset('build/images/flags/us.jpg') }}" alt="Header Language" height="16">
