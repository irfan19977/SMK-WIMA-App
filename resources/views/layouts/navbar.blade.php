<nav class="navbar navbar-expand-lg main-navbar sticky">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img alt="Profile avatar icon showing user profile picture in circular frame" 
                    src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('backend/assets/img/user.png') }}"
