        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">
                    Siswa: <strong>{{ $student->name }}</strong> &nbsp;|&nbsp;
                    Kelas: <strong>{{ $studentClass->name }}</strong> &nbsp;|&nbsp;
                    Semester: <strong>{{ $activeSemester->display_name }}</strong>
                </p>

                {{-- Filter Tanggal --}}
                <form method="GET" action="{{ route('parent.lesson-attendance') }}" class="row g-2 align-items-end mb-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-auto">
                        <a href="{{ route('parent.lesson-attendance') }}" class="btn btn-secondary">
