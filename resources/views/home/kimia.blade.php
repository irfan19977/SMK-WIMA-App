...
<main id="main">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="lead text-center mb-4">
            Jurusan Teknik Kimia Industri merupakan program keahlian yang mempelajari proses kimia untuk menghasilkan produk industri, pengolahan bahan baku, dan kontrol kualitas produk kimia.
          </p>

          <div class="row mt-4">
            <div class="col-md-6">
              <h4><i class="bi bi-bullseye text-primary me-2"></i>Visi Program</h4>
              <p>Menjadi program studi terdepan dalam menghasilkan tenaga ahli kimia industri yang kompeten, inovatif, dan berkontribusi pada pengembangan industri kimia berkelanjutan.</p>
            </div>
            <div class="col-md-6">
              ...
              <ul>
                ...
                <li>Environmental Safety Officer</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-md-6">
          ...
          <p class="text-muted">Laboratorium kimia dan fasilitas pendukung industri terkini</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="feature-card text-center">
            ...
            <h5>Lab Kimia Dasar</h5>
            <p class="text-muted">Laboratorium kimia dengan peralatan analisis kimia, spektrofotometer, dan instrumen laboratorium modern</p>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          <div class="feature-card text-center">
            ...
            <h5>Process Lab</h5>
            <p class="text-muted">Laboratorium proses kimia industri dengan reactor, distillation unit, dan heat exchanger</p>
          </div>
        </div>
        <div class="col-md-4 mb-4">
          <div class="feature-card text-center">
            ...
            <h5>Quality Control Lab</h5>
            <p class="text-muted">Laboratorium kontrol kualitas dengan HPLC, GC-MS, dan peralatan analisis mutu produk</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-md-6">
          ...
          <p class="text-muted">Berbagai peluang karir menanti lulusan Teknik Kimia Industri</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="text-center">
            <i class="bi bi-gear-wide-connected" style="font-size: 2.5rem; margin-bottom: 15px;"></i>
            <h6>Process Engineer</h6>
            <p class="text-muted">Merancang dan mengoptimalkan proses produksi kimia</p>
          </div>
        </div>
        <div class="col-md-3 mb-4">
          <div class="text-center">
            <i class="bi bi-search" style="font-size: 2.5rem; margin-bottom: 15px;"></i>
            <h6>Quality Control</h6>
            <p class="text-muted">Memastikan kualitas produk sesuai standar industri</p>
          </div>
        </div>
        <div class="col-md-3 mb-4">
          <div class="text-center">
            ...
            <p class="text-muted">Mengawasi proses produksi dan mengelola tim produksi</p>
          </div>
        </div>
        <div class="col-md-3 mb-4">
          <div class="text-center">
            <i class="bi bi-flower1" style="font-size: 2.5rem; margin-bottom: 15px;"></i>
            <h6>R&D Specialist</h6>
            <p class="text-muted">Mengembangkan produk dan proses kimia baru</p>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-3">
        <div class="col-md-6 mb-3">
          <div class="text-center">
            ...
            <p class="text-muted">Memastikan keselamatan kerja di industri kimia</p>
          </div>
        </div>
        <div class="col-md-6 mb-3">
          <div class="text-center">
            ...
            <h6>Plant Manager</h6>
            <p class="text-muted">Memimpin operasional pabrik kimia dan manufaktur</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section">
    <div class="container">
      <div class="row justify-content-center text-center mb-5">
        <div class="col-md-6">
          <h2 class="section-heading">Galeri Kimia Industri</h2>
          <p class="text-muted">Kegiatan pembelajaran dan fasilitas jurusan Teknik Kimia Industri</p>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 text-center">
          <h3>Bergabunglah dengan Jurusan Teknik Kimia Industri</h3>
          <p class="mb-4">Jadilah bagian dari generasi ahli kimia industri yang siap menghadapi tantangan industri modern dengan kompetensi unggulan dan sertifikasi internasional</p>
