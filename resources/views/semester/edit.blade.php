            ...
            <div class="form-group">
              ...
              <select name="academic_year" id="academic_year" class="form-control" required>
                ...
                @foreach($academicYears as $year)
                  <option value="{{ $year }}" {{ $semester->academic_year === $year ? 'selected' : '' }}>
                    {{ $year }}
                  </option>
                @endforeach
              </select>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="semester_type" id="semester_type" class="form-control" required>
                ...
                <option value="ganjil" {{ $semester->semester_type === 'ganjil' ? 'selected' : '' }}>Ganjil</option>
                <option value="genap" {{ $semester->semester_type === 'genap' ? 'selected' : '' }}>Genap</option>
              </select>
              @error('semester_type')
                <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
