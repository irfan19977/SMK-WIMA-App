...
@section('scripts')
    ...
    <script>
        ...
        function exportExcel() {
            const url = new URL('{{ route('lesson-attendances.export-excel') }}', window.location.origin);
        ...
        // Print PDF
        function printPDF() {
            const url = new URL('{{ route('lesson-attendances.print-pdf') }}', window.location.origin);
            const filters = new URLSearchParams(window.location.search);
            filters.delete('page');
            url.search = filters.toString();
            window.open(url.toString(), '_blank');
