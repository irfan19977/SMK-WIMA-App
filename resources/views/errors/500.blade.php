                    ...
                    <div>
                        <div class="text-center mb-4">
                            <div class="mt-5">
                                ...
                                <h4 class="mt-2 text-uppercase mt-4">Kesalahan Server</h4>
                                <p class="mt-4 text-muted w-50 mx-auto">Terjadi kesalahan pada server. Silakan coba lagi beberapa saat atau hubungi administrator.</p>
                            </div>
