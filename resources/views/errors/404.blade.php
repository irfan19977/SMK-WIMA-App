                    ...
                    <div>
                        <div class="text-center mb-4">
                            <div class="mt-5">
                                ...
                                <h4 class="mt-2 text-uppercase mt-4">Halaman Tidak Ditemukan</h4>
                                <p class="mt-4 text-muted w-50 mx-auto">Maaf, halaman yang Anda cari tidak tersedia. Silakan kembali ke dashboard.</p>
                            </div>
